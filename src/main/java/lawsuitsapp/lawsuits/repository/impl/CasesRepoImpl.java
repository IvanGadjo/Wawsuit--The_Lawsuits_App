...
public class CasesRepoImpl implements CasesRepo {
    ...
    public CasesRepoImpl(CasesRepoJPA casesRepoJPA, DocumentsRepo documentsRepo,DocumentsRepoJPA documentsRepoJPA){
...
//        });
    ...
    public void changePhaseOfCase(int id, String newPhase) throws CaseNotFoundException {
        Case editedCase = getCaseById(id);
        editedCase.setPhase(newPhase);

        editCase(id,editedCase);
    }
    ...
    public List<Case> getAllCasesByParentCaseId(int parentCaseId) throws CaseNotFoundException {
        List<Case> cases = getCaseById(parentCaseId).getChildCases();
